...
apt_bundle libpython3.9-minimal libpython3.9-stdlib libpython3-stdlib python3.9 python3.9-minimal python3.9-venv python3 python3-minimal python3-distutils python3-setuptools python3-urllib3 python3-packaging python3-six python3-certifi python3-chardet python3-idna python3-wheel python3-dev python3-pip python-pip-whl
