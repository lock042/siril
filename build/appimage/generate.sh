...
apt_bundle libpython3.9-stdlib libpython3-stdlib libpython3.9-minimal libpython3-minimal python3 python3.9 python3.9-minimal python3.9-venv python3.9-full
