...
int draw_sensor_tilt(fits *fit) {
	...
	psf_star **stars = peaker(&im, fit->naxes[2] > 1 ? GLAYER : RLAYER, &com.pref.starfinder_conf, &nbstars, NULL, FALSE, FALSE, MAX_STARS_FITTED, com.pref.starfinder_conf.profile, com.max_thread);
