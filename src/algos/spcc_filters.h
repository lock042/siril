...
const float Johnson_UBVI_wl[] = {	360.f, 370.f, 380.f, 390.f, 400.f, 410.f, 420.f, 430.f, 440.f, 450.f, 460.f, 470.f,
...
const float Johnson_B_sr[] = { 		0.f, 0.03f, 0.134f, 0.567f, 0.92f, 0.978f, 1.f, 0.978f, 0.935f, 0.853f, 0.74f, 0.64f,
									0.536f, 0.424f, 0.325f, 0.235f, 0.15f, 0.095f, 0.043f, 0.09f, 0.f, 0.f, 0.f, 0.f, 0.f,
									0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f};

const float Johnson_V_sr[] = {		0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.03f, 0.163f, 0.458f,
...
const float Optolong_Blue_wl[] = {  380,382,384,386,388,390,392,394,396,398,400,402,404,406,408,410,412,414,416,418,
...
const float Optolong_Blue_sr[] = {    0.487103,0.641832,0.702067,0.747306,0.792559,0.822237,0.84495,0.871089,0.889818,
...
const float Optolong_Green_wl[] = { 472,474,476,478,480,482,484,486,488,490,492,494,496,498,500,502,504,506,508,510,
                                    512,514,516,518,520,522,524,526,528,530,532,534,536,538,540,542,544,546,548,550,
                                    552,554,556,558,560,562,564,566,568,570};

const float Optolong_Green_sr[] = { 0,0.00211,0.031464,0.098462,0.282547,0.428682,0.579431,0.70095,0.783954,0.824455,
...
const float Optolong_Red_wl[] = {   572,574,576,578,580,582,584,586,588,590,592,594,596,598,600,602,604,606,608,610,612,
...
const float Optolong_Red_sr[] = {   0,0.02392,0.064858,0.119023,0.272804,0.372528,0.630103,0.817813,0.941956,0.971376,
...
const float Sony_IMX571_wl[] = {	420,430,440,450,460,470,480,490,500,510,520,530,540,550,560,570,580,590,600,610,620,
									630,640,650,660,670,680,690,700};

const float Sony_IMX571_qe[] = {	0.789702,0.845261,0.875913,0.902740,0.914637,0.914116,0.897399,0.899673,0.897235,
