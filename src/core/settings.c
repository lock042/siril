...
preferences pref_init = {
	...
	.phot_set = {
		...
		.aperture = 10.0,
		.auto_aperture_factor = 5.6,
		.flux_cut_factor = 1.0,
		.flux_inner_factor = 1.75,
		.flux_outer_factor = 1.75 * 1.50,
		.force_radius = TRUE,
		.minval = -1500.0,
		.maxval = 60000.0,
...
struct settings_access all_settings[] = {
	...
	{ "photometry", "inner_factor", STYPE_DOUBLE, N_("factor for inner radius automatic computation"), &com.pref.phot_set.auto_inner_factor, { .range_double = { 2.0, 20.0 } } },
	{ "photometry", "outer_factor", STYPE_DOUBLE, N_("factor for outer radius automatic computation"), &com.pref.phot_set.auto_outer_factor, { .range_double = { 2.0, 20.0 } } },
	{ "photometry", "flux_cut_factor", STYPE_DOUBLE, N_("Flux cutoff ratio"), &com.pref.phot_set.flux_cut_factor, { .range_double = { 0.1, 50. } }  },
	{ "photometry", "flux_inner_factor", STYPE_DOUBLE, N_("factor for inner radius in Flux cutoff mode"), &com.pref.phot_set.flux_inner_factor, { .range_double = { 1.5, 2.5 } } },
	{ "photometry", "flux_outer_factor", STYPE_DOUBLE, N_("factor for outer radius in Flux cutoff mode"), &com.pref.phot_set.flux_outer_factor, { .range_double = { 1.5, 3.5 } } },
	{ "photometry", "ape_strat", STYPE_INT, N_("aperture strategy"), &com.pref.phot_set.ape_strat, { .range_int = { 0, 4 } } },
