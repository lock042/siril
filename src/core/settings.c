...
preferences pref_init = {
	...
	.phot_set = {
		...
		.inner = 20.0,
		.outer = 30.0,
		.auto_aperture_factor = 3.4,
		.auto_inner_factor = 3.8,
		.auto_outer_factor = 5.1,
		.flux_cut_factor = 1.0,
...
struct settings_access all_settings[] = {
	...
	{ "photometry", "flux_inner_factor", STYPE_DOUBLE, N_("factor for inner radius in Flux cutoff mode"), &com.pref.phot_set.flux_inner_factor, { .range_double = { 1.5, 10.0 } } },
	{ "photometry", "flux_outer_factor", STYPE_DOUBLE, N_("factor for outer radius in Flux cutoff mode"), &com.pref.phot_set.flux_outer_factor, { .range_double = { 1.5, 10.0 } } },
