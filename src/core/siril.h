...
struct sequ {
	...
	int reglayer;		// layer used for registration
	regdata *regparam;	// *regparam, a structure for each image of the sequence
	...
	regdata *regparam_bkp;	// *regparam,  a structure for each image of the sequence, null if nothing to back up
	imstats ***stats_bkp;	// statistics of the images for 3 layers, may be null too
	disto_params distoparam;	// the distortion parameters used for the registration if any
