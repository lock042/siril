...
#define STR_PAYNE N_("Generalised hyperbolic stretch function proposed by David Payne in the astrobin forums.\n\nThe optional argument <b>-human</b> enables using human eye luminous efficiency weights to compute the luminance used to compute the stretch value for each pixel, instead of the simple mean of the channels pixel values. A second optional argument <b>-inverse</b> applies the inverse of the stretch specified by the other parameters.\n\nThere are a number of mandatory arguments:\n<b>stretch_factor</b> defines the strength of the stretch, between 0 and 10;\n<b>stretch_intensty</b> defines the intensity of the stretch near the focal point;\n<b>shadow_preservation</b> defines a shadow preserving range between 0 and SP where the stretch will be linear, preserving shadow detal;\n<b>stretch_focal_point</b> defines the focal point of the stretch, between 0 and 1;\n<b>headroom_preservation</b> defines a region between HP and 1 where the stretch is linear, preserving highlight details and preventing star bloat.\nThe optional parameter <b>black_point_offset</b> allows for stretching to a new black point. If this parameter is omitted it defaults to 0.")
...
#define STR_RMGREEN N_("Applies a chromatic noise reduction filter. It removes green noise in the current image. This filter is based on PixInsight's SCNR Average Neutral algorithm and it is the same filter used by HLVG plugin in Photoshop.\n\n<b>Type</b>=1 stands for Average Neutral Protection, while <b>type</b>=2 stands for Maximum Neutral Protection")
...
#define STR_SETFINDSTAR N_("Defines thresholds above the noise and star roundness for stars detection with FINDSTAR and REGISTER commands.\n\n<b>Sigma</b> must be greater or equal to 0.05 and <b>roundness</b> between 0 and 0.9")
...
#define STR_SUBSKY N_("Computes the level of the local sky background thanks to a polynomial function of an order <b>degree</b> and subtracts it from the image")
