...
#define STR_RESAMPLE N_("Resamples image with a factor <b>factor</b>")
...
#define STR_SAVEPNG N_("Saves current image into a PNG file: <b>filename</b>.png")
...
#define STR_SEQSPLIT_CFA N_("Same command as SPLIT_CFA but for the sequence <b>sequencename</b>.\n\nThe output sequences names start with the prefix \"CFA_\" unless otherwise specified with <b>-prefix=</b> option")
