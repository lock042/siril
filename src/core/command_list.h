...
static command commands[] = {
	...
	{"spcc", 0, "pcc [image_center_coords] [-noflip] [-platesolve] [-focal=] [-pixelsize=] [-limitmag=[+-]] [-downscale] [ { -monosensor= [ -rfilter= ] [ -gfilter= ] [ -bfilter= ] | -oscsensor= [ -oscfilter= ] [ -osclpf= ] } ] [ -whiteref= ] [ -max_spcc_stars= ]", process_spcc, STR_SPCC, TRUE, REQ_CMD_SINGLE_IMAGE | REQ_CMD_FOR_RGB },
