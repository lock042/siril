...
static command commands[] = {
	...
	{"resample", 1, "resample factor [-interp=] [-noclamp] [-clamp=]", process_resample, STR_RESAMPLE, TRUE, REQ_CMD_SINGLE_IMAGE},
	...
	{"rotate", 1, "rotate degree [-nocrop] [-interp=] [-noclamp] [-clamp=]", process_rotate, STR_ROTATE, TRUE, REQ_CMD_SINGLE_IMAGE},
