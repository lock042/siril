...
static command commands[] = {
	...
	{"convert", 1, "convert basename [-start=index]", process_convert, STR_CONVERT, TRUE},
	{"convertraw", 1, "convertraw basename [-debayer] [-fitseq] [-start=index]", process_convertraw, STR_CONVERTRAW, TRUE},
