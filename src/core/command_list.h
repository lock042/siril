...
static command commands[] = {
	...
	{"register", 1, "register sequence [-2pass] [-noout] [-drizzle] [-prefix=] [-minpairs=] [-transf=] [-layer=] [-maxstars=] [-nostarlist] [-interp=] [-clamp=] [-selected]", process_register, STR_REGISTER, TRUE, REQ_CMD_NO_THREAD},
	...
	{"resample", 1, "resample -scale=factor [-interp=] [-noclamp] [-clamp=]", process_resample, STR_RESAMPLE, TRUE, REQ_CMD_SINGLE_IMAGE},
	...
	{"rotate", 1, "rotate -angle=degree [-nocrop] [-interp=] [-noclamp] [-clamp=]", process_rotate, STR_ROTATE, TRUE, REQ_CMD_SINGLE_IMAGE},
