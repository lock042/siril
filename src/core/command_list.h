...
static command commands[] = {
	...
	{"mask_from_channel", 1, "mask_from_channel -channel= {-bitdepth=} {-invert} {-autostretch} {\"-filename=\"} {-layermask=}", process_mask_from_channel, STR_MASK_FROM_CHANNEL, TRUE, REQ_CMD_SINGLE_IMAGE},
	{"mask_from_color", 4, "mask_from_color -cr= -cg= -cb= -tol=  {-lum_min} {-lum_max} {-fr} {-invert} {-bitdepth=} {-layermask=}", process_mask_from_color, STR_MASK_FROM_COLOR, TRUE, REQ_CMD_SINGLE_IMAGE},
	{"mask_from_lum", 1, "mask_from_lum {-even} {-human} {-rw=} {-gw=} {-bw=} {-invert} {-autostretch} {\"-filename=\"} {-bitdepth=} {-layermask=}", process_mask_from_channel, STR_MASK_FROM_LUM, TRUE, REQ_CMD_SINGLE_IMAGE},
	{"mask_from_stars", 1, "mask_from_stars channel -r= {-invert} {-feather=} {-bitdepth=} {-layermask=}", process_mask_from_stars, STR_MASK_FROM_STARS, TRUE, REQ_CMD_SINGLE_IMAGE},
