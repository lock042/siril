...
static command commands[] = {
	...
	{"profile", 0, "profile -from=x,y -to=x,y [-tri] [-cfa] {-graph | [-filename=]} [-savedat] [-colorplot] [-width=] [-spacing=] [-wavenumber1= -wn1at=x,y -wavenumber2= -wn2at=x,y]", process_profile, STR_PROFILE, TRUE, REQ_CMD_SINGLE_IMAGE},
	...
	{"seqprofile", 0, "profile sequence -from=x,y -to=x,y [-tri] [-cfa] [-savedat] [-colorplot] [-width=] [-spacing=] [-wavenumber1= -wn1at=x,y -wavenumber2= -wn2at=x,y]", process_seq_profile, STR_SEQPROFILE, TRUE, REQ_CMD_NONE},
