...
static command commands[] = {
	...
	{"seqght", 6, "seqght sequence [-human | -even | -independent] D B LP SP HP [channels]", process_seq_ght, STR_SEQGHT, TRUE, REQ_CMD_NONE},
	...
	{"seqinvght", 6, "seqinvght sequence [-human | -even | -independent] D B LP SP HP [channels]", process_seq_invght, STR_SEQINVGHT, TRUE, REQ_CMD_NONE},
	{"seqinvmodasinh", 6, "seqinvmodasinh sequence [-human | -even | -independent] D LP SP HP [channels]", process_seq_invmodasinh, STR_SEQINVMODASINH, TRUE, REQ_CMD_NONE},
	{"seqlinstretch", 6, "seqlinstretch sequence [-human | -even | -independent] BP [channels]", process_seq_linstretch, STR_SEQLINSTRETCH, TRUE, REQ_CMD_NONE},
	...
	{"seqmodasinh", 6, "seqmodasinh sequence [-human | -even | -independent] D LP SP HP [channels]", process_seq_modasinh, STR_SEQINVMODASINH, TRUE, REQ_CMD_NONE},
