...
static command commands[] = {
	...
	{"select", 3, "select seqname from to", process_select, STR_SELECT, TRUE, REQ_CMD_NONE},
	...
	{"unselect", 3, "unselect seqname from to", process_unselect, STR_UNSELECT, TRUE, REQ_CMD_NONE},
