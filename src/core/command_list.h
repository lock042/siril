...
static command commands[] = {
	...
	{"profile", 2, "profile -from=x,y -to=x,y [-tri] [-cfa] {-graph | [-filename=]} [-savedat] [-layer=] [-width=] [-spacing=] [-wavenumber1= -wn1at=x,y -wavenumber2= -wn2at=x,y]", process_profile, STR_PROFILE, TRUE, REQ_CMD_SINGLE_IMAGE},
