...
static command commands[] = {
	...
	{"seqinvmodasinh", 5, "seqinvmodasinh sequence [-human | -even | -independent] D LP SP HP [channels]", process_seq_invmodasinh, STR_SEQINVMODASINH, TRUE, REQ_CMD_NONE},
	{"seqlinstretch", 2, "seqlinstretch sequence [-human | -even | -independent] BP [channels]", process_seq_linstretch, STR_SEQLINSTRETCH, TRUE, REQ_CMD_NONE},
	...
	{"seqmodasinh", 5, "seqmodasinh sequence [-human | -even | -independent] D LP SP HP [channels]", process_seq_modasinh, STR_SEQINVMODASINH, TRUE, REQ_CMD_NONE},
