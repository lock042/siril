 ...
 *
 *
 * This file contains functions related to zoom management and image display
 */
...
static int make_index_for_current_display(display_mode mode, WORD lo, WORD hi, int vport);
...
static void remap(int vport) {
	...
	if (mode == HISTEQ_DISPLAY) {
		...
		//set_viewer_mode_widgets_sensitive(FALSE);	// THIS HAS NOTHING TO DO HERE
	} else {
