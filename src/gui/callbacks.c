...
void update_MenuItem() {
	...
	/* Occultation process */
	GAction *action_occultation = g_action_map_lookup_action (G_ACTION_MAP(app_win), "occultation");
	g_simple_action_set_enabled(G_SIMPLE_ACTION(action_occultation), sequence_is_loaded());
	/* selection is needed */
