...
/* Score a single mono frame with the Laplace pipeline:
 ...
 * Laplacian for ranking, the per-AP correlation kernel) lives in the
 * common 0..65535 internal range. For 16-bit mono: passes through. */
