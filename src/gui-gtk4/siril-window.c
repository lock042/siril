...
static GActionEntry win_entries[] = {
	...
	{ "aspect-ratio",     aspect_ratio_activate,     "s", "'free'", aspect_ratio_state     },
	{ "selection-guides", selection_guides_activate, "s", "'0'",    selection_guides_state },
	{ "select-all",       select_all_activate }
};
...
static GActionEntry image_entries[] = {
	...
	{ "cut", cut_activate, NULL, "false", cut_state },
	...
	{ "show-nde-history", show_nde_history_activate }
};
