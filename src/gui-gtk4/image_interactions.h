...
typedef enum {
	...
	MOUSE_ACTION_FLIS_DRAG_LAYER, // 14 — pan the active FLIS layer's position_x/y
	MOUSE_ACTION_CURVES_PIPETTE, // 15
	MOUSE_ACTION_EDIT_APS // 16 — multipoint AP grid editor (left=add, right=remove, drag=move)
} mouse_status_enum;
